prompt --application/shared_components/user_interface/templates/calendar/small_calendar_017
begin
--   Manifest
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(77293716697327832)
,p_cal_template_name=>'Small Calendar'
,p_internal_name=>'SMALL_CALENDAR'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11SmallCalenderHolder"> ',
' <tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11SmallWeekCalendarHolder">',
'<tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11SmallDayCalendarHolder"> <tr> <td class="t11MonthTitle">#IMONTH# #DD#, #YYYY#</td> </tr><tr><td>',
''))
