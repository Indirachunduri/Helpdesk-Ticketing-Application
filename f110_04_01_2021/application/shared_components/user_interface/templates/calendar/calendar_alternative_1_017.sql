prompt --application/shared_components/user_interface/templates/calendar/calendar_alternative_1_017
begin
--   Manifest
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(77293519342327832)
,p_cal_template_name=>'Calendar, Alternative 1'
,p_internal_name=>'CALENDAR,_ALTERNATIVE_1'
,p_day_of_week_format=>'<th class="t11DayOfWeek">#IDAY#</th>'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11CalendarAlternative1Holder"> ',
' <tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11WeekCalendarAlternative1Holder">',
'<tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t11DayCalendarAlternative1Holder"> <tr><td class="t11MonthTitle">#IMONTH# #DD#, #YYYY#</td></tr><tr><td>',
''))
