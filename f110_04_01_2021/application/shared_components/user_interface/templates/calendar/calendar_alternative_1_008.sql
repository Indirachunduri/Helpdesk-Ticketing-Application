prompt --application/shared_components/user_interface/templates/calendar/calendar_alternative_1_008
begin
--   Manifest
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(75422139586450168)
,p_cal_template_name=>'Calendar, Alternative 1'
,p_internal_name=>'CALENDAR,_ALTERNATIVE_1'
,p_day_of_week_format=>'<th class="t14DayOfWeek">#IDAY#</th>'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t14CalendarHolder"> ',
' <tr>',
'   <td class="t14MonthTitle">#IMONTH# #YYYY#</td>',
' </tr>',
' <tr>',
' <td class="t14MonthBody">'))
,p_month_open_format=>'<table border="0" cellpadding="0" cellspacing="0" summary="0" class="t14Calendar">'
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t14WeekCalendarAlternative1Holder">',
'<tr>',
...
,p_weekly_month_open_format=>'<table border="0" cellpadding="0" cellspacing="0" summary="0" class="t14WeekCalendarAlternative1">'
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t14DayCalendarAlternative1Holder"> <tr><td class="t14MonthTitle">#IMONTH# #DD#, #YYYY#</td></tr><tr><td>',
''))
,p_daily_month_open_format=>'<table border="0" cellpadding="2" cellspacing="0" summary="0" class="t14DayCalendarAlternative1">'
