prompt --application/shared_components/user_interface/templates/calendar/small_calendar_009
begin
--   Manifest
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(75443229061455136)
,p_cal_template_name=>'Small Calendar'
,p_internal_name=>'SMALL_CALENDAR'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10SmallCalendarHolder"> ',
' <tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10SmallWeekCalendarHolder">',
'<tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10SmallDayCalendarHolder"> <tr> <td class="t10MonthTitle">#IMONTH# #DD#, #YYYY#</td> </tr><tr><td>',
''))
