prompt --application/shared_components/user_interface/templates/region/nested_region_002
begin
--   Manifest
--     REGION TEMPLATE: NESTED_REGION
--   Manifest End
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(75344429622425306)
,p_layout=>'TABLE'
