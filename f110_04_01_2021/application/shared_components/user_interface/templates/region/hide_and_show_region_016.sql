prompt --application/shared_components/user_interface/templates/region/hide_and_show_region_016
begin
--   Manifest
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(75860331864534618)
,p_layout=>'TABLE'
...
'<th class="t16RegionHeader"><img src="#IMAGE_PREFIX#themes/theme_16/collapse_plus.gif" alt="Toggle" align="middle" onclick="htmldb_ToggleTableBody(this,''body#REGION_ID#'')" class="pseudoButtonActive" />#TITLE#</th>',
