prompt --application/shared_components/user_interface/templates/region/button_region_without_title_017
begin
--   Manifest
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(77278916444327804)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table summary="" class="t11ButtonRegionwithoutTitle" border="0" cellpadding="0" cellspacing="0" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tr>',
