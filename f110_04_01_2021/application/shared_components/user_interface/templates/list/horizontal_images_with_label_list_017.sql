prompt --application/shared_components/user_interface/templates/list/horizontal_images_with_label_list_017
begin
--   Manifest
...
wwv_flow_api.create_list_template(
 p_id=>wwv_flow_api.id(77285239041327812)
,p_list_template_current=>'<td class="t11current"><img src="#IMAGE_PREFIX##IMAGE#" border="0" #IMAGE_ATTR#/><br />#TEXT#</td>'
