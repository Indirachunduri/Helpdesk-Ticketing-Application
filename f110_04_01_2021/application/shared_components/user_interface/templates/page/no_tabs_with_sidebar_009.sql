prompt --application/shared_components/user_interface/templates/page/no_tabs_with_sidebar_009
begin
--   Manifest
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(77274843651327792)
,p_theme_id=>11
...
'<td colspan="2" width="100%" height="41" background="#IMAGE_PREFIX#themes/theme_11/t4top.gif"><br /></td>',
...
'<tr>',
'<td valign="top" width="100%"><div class="t11messages">#SUCCESS_MESSAGE##NOTIFICATION_MESSAGE#</div>#BODY##REGION_POSITION_04##REGION_POSITION_05##REGION_POSITION_06##REGION_POSITION_07##REGION_POSITION_08#</td>',
