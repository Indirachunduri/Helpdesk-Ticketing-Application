prompt --application/shared_components/user_interface/templates/page/no_tabs_009
begin
--   Manifest
--     TEMPLATE: NO_TABS
--   Manifest End
...
wwv_flow_api.create_template(
 p_id=>wwv_flow_api.id(77274515903327792)
,p_theme_id=>11
,p_name=>'No Tabs'
...
'<td colspan="2" align="right" valign="top" nowrap="nowrap" style="background-color:#91C58D"><br /></td>',
...
'</tr>',
'<tr> ',
'<td height="41" style="background-color:#91C58D"><br /></td>',
...
'</tr>',
'<tr> ',
'<td align="center" valign="top" style="background-color:#91C58D"><br  /></td>',
'<td width="31"><br /></td>',
'<td align="left" valign="top" colspan="2">',
'#REGION_POSITION_01#',
'<table summary="" cellpadding="0" cellspacing="0" border="0" width="100%">',
'<tr>',
'<td valign="top" width="100%"><div class="t11messages">#SUCCESS_MESSAGE##NOTIFICATION_MESSAGE#</div>#BODY##REGION_POSITION_02##REGION_POSITION_04#</td>',
...
'</tr>',
'<tr> ',
'<td width="28" height="41" style="background-color:#91C58D"><img src="#IMAGE_PREFIX#themes/theme_11/t4bottomcornerleft.gif" width="28" height="45"   border="0"  alt=""/></td>',
