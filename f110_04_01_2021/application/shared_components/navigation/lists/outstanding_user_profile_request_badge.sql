prompt --application/shared_components/navigation/lists/outstanding_user_profile_request_badge
begin
--   Manifest
--     LIST: Outstanding User Profile Request Badge
--   Manifest End
...
wwv_flow_api.create_list(
 p_id=>wwv_flow_api.id(5627268657387300)
,p_name=>'Outstanding User Profile Request Badge'
,p_list_type=>'SQL_QUERY'
,p_list_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select null as lvl, -- This Column is mandatory it seems',
'       ''Outstanding'' as label, -- Its a label Column',
