...
,p_last_upd_yyyymmddhh24miss=>'20210331150034'
);
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(89784638581633057)
...
,p_is_default=>'Y'
,p_display_rows=>5
,p_report_columns=>'TASK_ID:TASK_CATEGORY:TASK_NAME:CUSTOMER_NAME:DATE_DUE:PRIORITY:STATUS_CODE:LAST_UPDATE_DATE:LUPD_LAST:PERCENT_COMPLETE:VALUE_KPI'
