...
,p_name=>'Common Questions'
,p_step_title=>'Common Questions'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(176519828465581699)
,p_plug_name=>'Common Questions'
...
'and WBS_PROJ_TASKS.PUBLISH_FAQ_FLAG = ''Y''',
'and wbs_proj_tasks.task_cat_id = tc.task_cat_id(+)'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(176520038957581702)
...
,p_detail_link=>'f?p=&APP_ID.:194:&SESSION.::&DEBUG.::P194_TASK_ID:#TASK_ID#'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176520137404581705)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176521741047581711)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176522814468581712)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176523325444581713)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176520836545581710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176520932184581710)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(176521416010581710)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(176525144228581716)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_type=>'REPORT'
,p_report_alias=>'1083010'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>5
,p_report_columns=>'TASK_CATEGORY:TASK_NAME:TASK_DESCRIPTION'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(176525517576581723)
,p_plug_name=>'Support FAQ'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(176708523179442587)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(176519828465581699)
,p_button_name=>'BACK'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(176526432194581736)
,p_branch_action=>'f?p=&APP_ID.:193:&SESSION.'
