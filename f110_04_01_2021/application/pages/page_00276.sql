...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213620017423126025)
,p_plug_name=>'Invoice'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213626635886126042)
...
'WHERE l.invoice_header_id = :P276_INVOICE_HEADER_ID',
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(213626836292126042)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627019770126048)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213626942160126044)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627316956126048)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627439609126049)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627131187126048)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627217487126048)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627519162126049)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627630037126049)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627737086126049)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627825577126049)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(213627927951126050)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(213628015509126050)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1454039'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(213628240023126053)
,p_report_id=>wwv_flow_api.id(213628015509126050)
...
wwv_flow_api.create_worksheet_condition(
 p_id=>wwv_flow_api.id(213628331311126053)
,p_report_id=>wwv_flow_api.id(213628015509126050)
,p_condition_type=>'FILTER'
,p_allow_delete=>'Y'
,p_column_name=>'LINE_TYPE'
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(213628628943126054)
,p_plug_name=>'Invoice Detail '
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213620427129126026)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(213620017423126025)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213620616194126026)
...
,p_button_condition=>'P276_INVOICE_HEADER_ID'
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213620819910126026)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(213628424098126054)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_api.id(213626635886126042)
,p_button_name=>'CREATE'
,p_button_action=>'REDIRECT_PAGE'
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(213630039554126063)
,p_branch_action=>'f?p=&APP_ID.:272:&SESSION.::&DEBUG.:::&success_msg=#SUCCESS_MSG#'
,p_branch_point=>'AFTER_PROCESSING'
,p_branch_type=>'REDIRECT_URL'
,p_branch_sequence=>1
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213621041748126027)
,p_name=>'P276_AMOUNT_DUE_REMAINING'
,p_item_sequence=>130
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
...
,p_help_text=>'Amount outstanding.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213621512621126030)
,p_name=>'P276_INVOICE_HEADER_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213621724564126032)
,p_name=>'P276_TRX_NUMBER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213622241176126032)
,p_name=>'P276_TRX_DATE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Date'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Transaction Date. Date of transaction.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213622726645126032)
,p_name=>'P276_INVOICE_CURRENCY_CODE'
,p_item_sequence=>100
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Currency'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Currency type code.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213623218938126033)
,p_name=>'P276_CUSTOMER_ID'
,p_item_sequence=>60
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213623434673126033)
,p_name=>'P276_TYPE_NAME'
,p_item_sequence=>70
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Transaction description.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213623919172126033)
,p_name=>'P276_CT_PURCHASE_ORDER'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Customer purchase order reference number.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213624425377126034)
,p_name=>'P276_CT_REFERENCE'
,p_item_sequence=>90
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Reference'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Customer Order reference number.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213624911705126034)
,p_name=>'P276_DUE_DATE'
,p_item_sequence=>115
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Due Date'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Date payment is due.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213625420134126034)
,p_name=>'P276_AMOUNT_DUE_ORIGINAL'
,p_item_sequence=>95
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Original invoice amount due.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(213625934487126035)
,p_name=>'P276_AL_STATUS_MEANING'
,p_item_sequence=>140
,p_item_plug_id=>wwv_flow_api.id(213620017423126025)
,p_use_cache_before_default=>'NO'
,p_prompt=>'Status'
...
,p_item_template_options=>'#DEFAULT#'
,p_lov_display_extra=>'NO'
,p_help_text=>'Transaction status.'
,p_attribute_01=>'N'
,p_attribute_02=>'VALUE'
,p_attribute_04=>'Y'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213629536547126062)
,p_process_sequence=>10
,p_process_point=>'AFTER_HEADER'
,p_process_type=>'NATIVE_FORM_FETCH'
,p_process_name=>'Fetch Row from WBS_INVOICE_HEADER'
,p_attribute_02=>'WBS_INVOICE_HEADER'
,p_attribute_03=>'P276_INVOICE_HEADER_ID'
,p_attribute_04=>'INVOICE_HEADER_ID'
,p_process_error_message=>'Unable to fetch row.'
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213629733476126062)
,p_process_sequence=>10
...
'  end; ',
'begin ',
'  :P276_INVOICE_HEADER_ID := get_pk; ',
'end; '))
,p_process_clob_language=>'PLSQL'
,p_process_error_message=>'Unable to get primary key item value.'
,p_process_when_button_id=>wwv_flow_api.id(213620616194126026)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213629115720126060)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(213629321684126062)
...
,p_attribute_04=>'94'
,p_process_when_button_id=>wwv_flow_api.id(213620819910126026)
);
