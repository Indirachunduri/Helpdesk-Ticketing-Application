prompt --application/shared_components/user_interface/templates/region/form_region_017
begin
--   Manifest
...
wwv_flow_api.create_plug_template(
 p_id=>wwv_flow_api.id(77279813152327805)
,p_layout=>'TABLE'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table summary="" class="t11FormRegion" border="0" cellpadding="0" cellspacing="0" id="#REGION_STATIC_ID#" #REGION_ATTRIBUTES#>',
'<tr>',
