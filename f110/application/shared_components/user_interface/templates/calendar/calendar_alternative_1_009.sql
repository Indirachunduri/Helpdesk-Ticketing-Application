prompt --application/shared_components/user_interface/templates/calendar/calendar_alternative_1_009
begin
--   Manifest
...
wwv_flow_api.create_calendar_template(
 p_id=>wwv_flow_api.id(75443030029455136)
,p_cal_template_name=>'Calendar, Alternative 1'
,p_internal_name=>'CALENDAR,_ALTERNATIVE_1'
,p_day_of_week_format=>'<th class="t10DayOfWeek">#IDAY#</th>'
,p_month_title_format=>wwv_flow_string.join(wwv_flow_t_varchar2(
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10CalendarAlternative1Holder"> ',
' <tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10WeekCalendarAlternative1Holder">',
'<tr>',
...
'<table cellspacing="0" cellpadding="0" border="0" summary="" class="t10DayCalendarAlternative1Holder"> <tr><td class="t10MonthTitle">#IMONTH# #DD#, #YYYY#</td></tr><tr><td>',
''))
