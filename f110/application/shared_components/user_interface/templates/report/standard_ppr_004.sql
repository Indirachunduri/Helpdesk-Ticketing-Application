prompt --application/shared_components/user_interface/templates/report/standard_ppr_004
begin
--   Manifest
...
wwv_flow_api.create_row_template(
 p_id=>wwv_flow_api.id(77291137171327823)
,p_row_template_name=>'Standard (PPR)'
,p_internal_name=>'STANDARD_PPR'
,p_row_template1=>'<td #ALIGNMENT# headers="#COLUMN_HEADER#" class="t11data">#COLUMN_VALUE#</td>'
...
'</table><div class="t11CVS">#EXTERNAL_LINK##CSV_LINK#</div></td></tr>#PAGINATION#</table><script language=JavaScript type=text/javascript>',
'<!--',
