prompt --application/shared_components/user_interface/lovs/users_system_and_system_user_admins
begin
--   Manifest
--     USERS SYSTEM AND SYSTEM USER ADMINS
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(455594519875475004)
,p_lov_name=>'USERS SYSTEM AND SYSTEM USER ADMINS'
