prompt --application/shared_components/user_interface/lovs/task_users_and_higher
begin
--   Manifest
--     TASK USERS AND HIGHER
--   Manifest End
...
wwv_flow_api.create_list_of_values(
 p_id=>wwv_flow_api.id(90303527903910982)
,p_lov_name=>'TASK USERS AND HIGHER'
