prompt --application/shared_components/navigation/trees/catalog_navigation_tree
begin
--   Manifest
--     TREE: Catalog Navigation Tree
--   Manifest End
...
wwv_flow_api.create_tree(
 p_id=>wwv_flow_api.id(489975829341896985)
,p_name=>'Catalog Navigation Tree'
,p_type=>'DYNAMIC'
,p_item=>'P35_TREE_ROOT'
,p_query=>wwv_flow_string.join(wwv_flow_t_varchar2(
'select CATALOG_ID id, ',
'       PARENT_CATALOG_ID pid, catalog_name        ||''  ('' || CATALOG_ID || '')   ''  || DESCRIPTION name, ',
'       ''f?p=&APP_ID.:62:&SESSION.::NO::P62_CATALOG_ID:''||CATALOG_ID link, ',
'       null a1, ',
'       null a2 ',
'from WBS_CATALOGS',
