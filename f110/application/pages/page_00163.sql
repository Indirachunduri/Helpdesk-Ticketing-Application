...
,p_last_upd_yyyymmddhh24miss=>'20210215233333'
);
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86865543409896092)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(86868918952896119)
...
wwv_flow_api.create_report_region(
 p_id=>wwv_flow_api.id(86870441020065425)
,p_name=>'Attachments'
...
'WHERE ATT_ID = :P163_ATT_ID'))
,p_display_when_condition=>'INSTR(:P163_MIMETYPE, ''image'') = 1'
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(86870729975065433)
,p_query_column_id=>1
...
wwv_flow_api.create_report_columns(
 p_id=>wwv_flow_api.id(86870843635065433)
,p_query_column_id=>2
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86866025617896094)
,p_button_sequence=>10
,p_button_plug_id=>wwv_flow_api.id(86865543409896092)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86865928130896093)
...
,p_button_condition=>'P163_ATT_ID'
,p_button_condition_type=>'ITEM_IS_NOT_NULL'
,p_database_action=>'DELETE'
);
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86865835073896093)
...
wwv_flow_api.create_page_button(
 p_id=>wwv_flow_api.id(86865719978896093)
...
wwv_flow_api.create_page_branch(
 p_id=>wwv_flow_api.id(86866713891896097)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86866919971896098)
,p_name=>'P163_ATT_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86867127486896112)
,p_name=>'P163_TASK_ID'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86867311647896115)
,p_name=>'P163_DESCRIPTION'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
,p_use_cache_before_default=>'NO'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86867522449896115)
,p_name=>'P163_CONTENT'
,p_is_required=>true
,p_item_sequence=>40
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(86867727339896116)
,p_name=>'P163_MIMETYPE'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
,p_use_cache_before_default=>'NO'
,p_source=>'MIMETYPE'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(87042034695983246)
,p_name=>'P163_FILENAME'
,p_item_sequence=>45
,p_item_plug_id=>wwv_flow_api.id(86865543409896092)
,p_use_cache_before_default=>'NO'
,p_source=>'FILENAME'
...
,p_process_when_button_id=>wwv_flow_api.id(86865719978896093)
);
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86868514574896118)
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(86868717641896119)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_api.id(86865928130896093)
);
