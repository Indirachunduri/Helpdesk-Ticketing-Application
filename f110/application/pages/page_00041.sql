...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(77305224642551885)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(77305622523551888)
,p_plug_name=>'Import Logs'
...
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(77305712031551888)
,p_name=>'Import Logs'
,p_max_row_count=>'1000000'
,p_max_row_count_message=>'This query returns more than 1000,000 rows, please filter your data to ensure complete results.'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79083730160881967)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79083821297881968)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79084726182918669)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79084840454918669)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79084942182918669)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79085043144918670)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79085141333918670)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(79087034372987286)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(77307328213937001)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'1319230399697890'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
