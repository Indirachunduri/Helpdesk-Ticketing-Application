...
,p_last_upd_yyyymmddhh24miss=>'20210525210003'
);
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(53185952239535695)
,p_plug_name=>'New'
,p_parent_plug_id=>wwv_flow_api.id(182486926714947281)
