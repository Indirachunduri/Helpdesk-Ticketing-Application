...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(74351838063464688)
...
wwv_flow_api.create_page_plug(
 p_id=>wwv_flow_api.id(74352226271464710)
,p_plug_name=>'Find Saved Cart'
...
'       wbs_cart_headers.order_customer_name,',
'       u.username',
'  FROM wbs_cart_headers, wbs_users u',
' WHERE /* USER_ID = :F111_USER_ID and */',
'       wbs_cart_headers.customer_id = :f111_customer_id',
'   AND cart_status = ''S''',
'   AND u.user_id = wbs_cart_headers.created_by',
'   AND op_unit_id = :f111_op_unit_id',
'ORDER BY wbs_cart_headers.last_update_date DESC'))
,p_plug_source_type=>'NATIVE_IR'
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
);
wwv_flow_api.create_worksheet(
 p_id=>wwv_flow_api.id(74352325144464710)
,p_name=>'Find Saved Cart'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74352530620464748)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(74352619071464758)
,p_db_column_name=>'CART_NAME'
,p_display_order=>2
,p_column_identifier=>'B'
,p_column_label=>'Cart Name'
,p_column_link=>'f?p=&APP_ID.:112:&SESSION.::&DEBUG.::P112_CART_ID:#CART_ID#'
,p_column_linktext=>'#CART_NAME#'
,p_allow_pivot=>'N'
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127488728902628631)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127488844209628635)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127488933233628635)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127489021871628636)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127489115565628636)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127489222887628636)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127489313421628636)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(127489424905628636)
...
wwv_flow_api.create_worksheet_column(
 p_id=>wwv_flow_api.id(64697396224702314)
...
wwv_flow_api.create_worksheet_rpt(
 p_id=>wwv_flow_api.id(74352734974466154)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'61286'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
,p_display_rows=>15
,p_report_columns=>'CART_NAME:CREATION_DATE:ORDER_NAME:ORDER_PHONE:ORDER_EMAIL:PO_NUMBER:LAST_UPDATE_DATE:USERNAME:'
);
